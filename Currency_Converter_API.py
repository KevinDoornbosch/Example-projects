...
headlabel = tk.Label(Tops, font=('lato black', 24, 'bold'), text='Currency converter : ',
					bg='#e6e5e5', fg='black')
headlabel.grid(row=1, column=1, sticky="NEWS")
...
CurrenyCode_list = ["INR", "USD", "CAD", "CNY", "DKK", "EUR", "GBP"]
